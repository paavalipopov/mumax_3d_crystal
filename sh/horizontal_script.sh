...
do
	...
	gnuplot -e "set terminal png size 1280,980 enhanced font 'Helvetica,20'; set output '$result B_ext_ortho.png'; set size ratio -1; set grid; plot 'H_eff_ortho.gplot' using 2:3:5 with image"
	cd $directory
